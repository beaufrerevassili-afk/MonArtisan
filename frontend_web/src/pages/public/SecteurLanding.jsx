...
const PROS_DEMO = {
  restaurant: [
    { id:1, nom:'Chez Marco', type:'Sur place', ville:'Marseille 6e', note:4.8, avis:89, dispo:true, bio:'Cuisine italienne authentique, pâtes fraîches maison.', grad:'linear-gradient(140deg,#E8C8A0,#C8A070)', initials:'CM', services:[{nom:'Menu midi',prix:16},{nom:'Menu soir complet',prix:28},{nom:'Pizza au feu de bois',prix:14}], horaires:'Lun–Dim · 12h–22h30' },
    { id:2, nom:'Le Bistrot Paulette', type:'Sur place', ville:'Marseille 8e', note:4.9, avis:201, dispo:true, bio:'Cuisine française, produits du marché, vins naturels.', grad:'linear-gradient(140deg,#D4B0A0,#B09080)', initials:'BP', services:[{nom:'Formule midi',prix:19},{nom:'Menu dégustation',prix:48}], horaires:'Mar–Sam · 12h–14h · 19h30–22h' },
    { id:3, nom:'Sushi Kokoro', type:'Sur place', ville:'Marseille 1er', note:4.7, avis:134, dispo:true, bio:'Sushis artisanaux, poissons frais quotidiens.', grad:'linear-gradient(140deg,#A8B8C8,#8898A8)', initials:'SK', services:[{nom:'Menu déjeuner',prix:15},{nom:'Plateau sushis',prix:22},{nom:'Omakase',prix:55}], horaires:'Lun–Sam · 12h–14h30 · 19h–22h' },
    { id:4, nom:'La Brasserie du Port', type:'Sur place', ville:'Marseille 2e', note:4.5, avis:312, dispo:false, bio:'Brasserie emblématique avec vue sur le Vieux-Port.', grad:'linear-gradient(140deg,#C0B8A8,#A09880)', initials:'BP', services:[{nom:'Formule brasserie',prix:24},{nom:'Fruits de mer',prix:38}], horaires:'Lun–Dim · 11h30–23h' },
  ],
};
